...
| [Прогнозирование количества заказов такси на следующий час](./taxi_prediction) | Разработать систему предсказания кол-ва заказов такси на следующий час | *pandas, numpy, scikit-learn, catboost, datetime* |
